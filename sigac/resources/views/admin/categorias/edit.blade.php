...
<body>
    <div class="page-container">
        ...
        <form method="POST" action="{{ route('categorias.update', $categoria->id) }}" class="form-eixo">
            @csrf
            @method('PUT')
            ...
            <div class="form-group horizontal-group">
                <div class="input-block">
                    ...
                    <input type="number" step="1.0" id="maximo_horas" name="maximo_horas" value="{{ old('maximo_horas', $categoria->maximo_horas) }}" required>
                </div>
